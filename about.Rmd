...
* **Distribution:**
How is the forest fire distributed in the park? How large can the forest fire be? (put in summary table)
...
* **Suggestions:** 
What can we suggest from the data? (Ex: For tourists and fire department)


* **Future Plans:** 
How is the variables related to each other? Can we give a more precise prediction of the area based on the variables we have now?
