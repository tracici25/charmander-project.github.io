...
* [Fire Count](https://tracici25.github.io/charmander-project.github.io/barchart.html) 
...
When cleaning the data, we firstly converted “Month” as a factor which can be used in barchart. Then we excluded the coordinate data, calculated means of every parameter, and pivoted them into a long column.
