...
In `Overview`, we can find `Descriptive Statistics`, `Geography`, and `Observation by Time`.

[Geography](https://tracici25.github.io/charmander-project.github.io/geography.html) provide a clear map

* Darker areas represent higher counts of wildfires in that area across year 2000 to 2003.
* 
